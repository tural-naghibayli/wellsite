...
$("#RigUp").click(function(){
  ...
  "Held TBT with all involved regarding rigging up casing running equipment.\n\n"+
  "Rigged up ___company_name___ equipment as per ___company_name___ rep instruction.\n"+
"- Picked up ___company_name___ Overdrive from TFM to Rig floor.\n"+
"- Made up DDM and torque to __klbs as per ___company_name___ rep instruction.\n"+
"- Picked up ___\" water bushing and made up to ___\" TIW.\n"+
"- Monitored well over trip tank.\n"
...
$("#MakeUpBHA").click(function(){
  ...
  $("#report").text(
        ...
        "P/U and M/U \" BHA from __m to ___m. \n \n"+

        "- Held TBT with all involved crew.\n"+
        "- Confirmed nozzle size on the bit: __x__/32\", x__/32\".\n"+
        "- P/U & M/U ___\" Bit and Geo-pilot/Mud-motor assembly.\n"+
        "- P/U & M/U EWR-M5 collar assembly.\n"+
        "- P/U & M/U ___\" Negative/Positive pulser assembly.\n"+
        "- Plugged in LWD tools and programmed tool . \n"+
        "- P/U & M/U ___ c/w PFV/NPFV. Confirmed PFV/NPFV. \n"+
        "- P/U & M/U ___\" DC + ___\" string stab.\n"+
        "- M/U  __ x ___\" DC.\n"+
        "- Monitored well on trip tank.\n"+
        "\n"+
        "_________________________________________________________________\n\n"+
        "MU Jar and Accelerator\n\n"+
        "RIH ___\" BHA from ___m to ___m on ___\" HWDP.\n\n"+

        "- M/U __\" Hydraulic jar at ___m.\n"+
        "- M/U __ x ___\" HWDP.\n"+
        "- M/U __\" accelerator at ___m.\n"+
        "- Wt Below Jar:  ___ klbs,  BHA Wt: ___ klbs\n"+
        "- Monitored well on trip tank. Correct displacement noted.\n"
    //WRITE your text template
...
$("#JetBOP").click(function(){
  console.log("Clicked 2");
  $("#report").text(

    "PU WBRT and retrieved wear bushing.\n\n"+

  "- No damages observed on wear bushing.\n"+
  "- Monitored well over trip tank.\n"+
  "\n"+
  "_________________________________________________________________\n\n"+
  "Jet of BOP and Wellhead\n\n"+

  "- Picked up and made up BOP jetting tool and magnostar.z\n"+
  "- Weekly function tested BOP.\n"+
  "- Jet Annular ___ gpm, ___ psi, UPR and LPR with ___ gpm, ___ psi, Well head with ___ gpm, ___ psi.\n"+
  "- POOH and laid out jetting tool and magno star. No swarf debris observed on magnets.\n"+
  "\n"+
  "_________________________________________________________________\n\n"+
  "Set wear bushing\n\n"+

"- Picked up wear bushing running tool, run and set wear bushing in well head profile.\n"+
"- Monitored well over trip tank\n"
  //WRITE your text template
...
$("#RigUpDownPS30").click(function(){
  console.log("Clicked 2");
  $("#report").text(

  "Rig Up PS-30s.\n\n"+

  "Changed out master bushings to PS-30s.\n"+

  "- Removed master bushing and adapter.\n"+
  "- Installed PS-30 slips and connected hydraulic hoses.\n"+
  "- Monitored well over trip tank.\n\n"+
"_________________________________________________________________\n\n"+
  "Rig Down PS-30s.\n\n"+

  "Changed out PS-30s to master bushings.\n"+
  "- Removed PS-30 slips and disconnected hydraulic hoses.\n"+
  "- Installed master bushing and adapter.\n"+
  "- Monitored well over trip tank.\n"
...
$("#NippleUpBOP").click(function(){
  console.log("Clicked 2");
  $("#report").text(

  "Nipple up BOP and Risers.\n\n"+

  "Nippled up lower and upper HP risers.\n\n"+
"- Held comprehensive TBT with drill crew. \n"+
"- Put manual elevator on riser RT and connected secondary retention slings.\n"+
"- Picked up lower HP riser, RIH and landed on ____well head / spool tree_____. Installed drilling hatch half moons.\n"+
"- Connected riser fast locks 'hand tight'.\n"+
"- Disconnect RT and pulled to rig floor.\n"+
"- Connected riser RT and secondary retention to Upper HP riser.\n"+
"- RIH and land same onto LHP riser.\n"+
"- Connected riser fast locks 'hand tight'.\n"+
"- Disconnected, pulled RT and laid out.\n"+

"_________________________________________________________________\n\n"+

  "Nippled up BOP.\n\n"+

"- Picked up Bell nipple sleeve RT and engaged to sleeve.\n"+
"- Set bell nipple sleeve and laid out BNS RT.\n"+
"- Skidded BOP to well center.\n"+
"- Lifted BOP and skid trolley off well center.\n"+
"- Landed BOP onto upper HP riser and hand tight fast.\n"+

"_________________________________________________________________\n\n"+

"Nippled up LP risers.\n\n"+
"- Picked up upper LP riser joint and landed onto BOP.\n"+
"- Dis-engaged and laid out Upper LP riser hydraulic RT.\n"+
"- Drill crew torqued up riser & BOP fast locks from well bay to rig floor.\n"+
"- Filled up risers with sea water and performed visual leak checks - all ok.\n"
...
$("#NippleDownBOP").click(function(){
  console.log("Clicked 2");
  $("#report").text(

  "Nipple down BOP and Risers.\n\n"+

  "- RIH with LP riser RT, recovered and laid out same.\n"+
  "- Backed out fast lock connections on BOP deck.\n"+
  "- Picked up and run Bell Nipple Sleeve running tool.\n"+
  "- Pulled bell nipple sleeve.\n"+
  "- Picked up BOP.\n"+
  "- Laid BOP on trolley and skidded trolley off well centre.\n"+
  "- Drained Riser.\n"+
  "- Run riser running/releasing tool.\n"+
  "- Nipple upper HP riser , retrieved and laid down.\n"
